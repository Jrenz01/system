...
class Mactan extends StatefulWidget {
  @override
  _MactanState createState() => _MactanState();
}

class _MactanState extends State<Mactan> {
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Column(
                                children: [
                                  Image.asset('assets/image/mactan.png'), // Replace 'assets/image/mayon.jpg' with the actual image path
                                  Text(
                                    '\nThe Mactan Shrine is a monument located in Lapu-Lapu City, '
                                        'Cebu, Philippines, dedicated to the Battle of Mactan, '
                                        'which occurred on April 27, 1521. It commemorates the '
                                        'bravery of Lapu-Lapu, a native chieftain who led his warriors '
                                        'to victory over the Spanish forces led by the Portuguese '
