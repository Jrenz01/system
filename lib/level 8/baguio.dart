                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Column(
                                children: [
                                  Image.asset('assets/image/baguio.png'), // Replace 'assets/image/mayon.jpg' with the actual image path
                                  Text(
                                    '\nBaguio City is a mountain resort town located in the '
                                        'province of Benguet, in the northern part of the Philippines. '
                                        'Today, Baguio City is a popular '
                                        'tourist destination in the Philippines, and is known for its '
                                        'cultural and historical landmarks, including the Baguio Cathedral, '
                                        'Burnham Park, and the Tam-Awan Village.',
                                  ),
                                ],
                              ),
