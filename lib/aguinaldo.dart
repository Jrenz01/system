                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Column(
                                children: [
                                  Image.asset('assets/image/aguinaldo.jpg'), // Replace 'assets/image/mayon.jpg' with the actual image path
                                  Text(
                                    '\nThe Emilio Aguinaldo Shrine or the Cavite El Viejo Shrine is '
                                        'a national shrine located in Kawit, Cavite in the Philippines, '
                                        'where the Philippine Declaration of Independence from Spain '
                                        'was declared on June 12, 1898 or Independence Day, '
