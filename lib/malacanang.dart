                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Column(
                                children: [
                                  Image.asset('assets/image/malacanang.png'), // Replace 'assets/image/mayon.jpg' with the actual image path
                                  Text(
                                    '\nMalacañang Palace is the official residence and '
                                        'principal workplace of the President of the Philippines. '
                                        'Located in the capital city of Manila, the palace complex '
                                        'consists of several buildings, including the main palace, '
                                        'presidential offices, and a museum. The palace has a long '
                                        'and storied history, having served as the residence of '
                                        'Spanish colonial governors, American governors-general, '
