...
class Underground extends StatefulWidget {
  @override
  _UndergroundState createState() => _UndergroundState();
}

class _UndergroundState extends State<Underground> {
                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Column(
                                children: [
                                  Image.asset('assets/image/underground.jpg'), // Replace 'assets/image/mayon.jpg' with the actual image path
                                  Text(
                                    '\nThe Puerto Princesa Underground River in Palawan, Philippines,  '
                                        'is a UNESCO World Heritage Site and one of the longest navigable underground rivers globally '
                                        't flows for 8.2 kilometers and features stunning '
                                        'imestone formations and chambers. ',
                                  ),
                                ],
                              ),
