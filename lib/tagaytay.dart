                        ...
                        showDialog(
                          ...
                          builder: (BuildContext context) {
                            return AlertDialog(
                              ...
                              content: Column(
                                children: [
                                  Image.asset('assets/image/tagaytay.JPG'), // Replace 'assets/image/mayon.jpg' with the actual image path
                                  Text(
                                    '\nTagaytay, officially the City of Tagaytay, '
                                        'is a 2nd class component city in the province '
                                        'of Cavite, Philippines. According to the 2020 '
                                        'census, it has a population of 85,330 people. '
                                        'Tagaytay overlooks Taal Lake in Batangas '
                                        'and provides views of Taal Volcano Island in '
                                        'the middle of the lake through various vantage '
